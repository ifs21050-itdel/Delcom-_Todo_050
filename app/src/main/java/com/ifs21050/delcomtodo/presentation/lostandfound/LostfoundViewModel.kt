...
import com.ifs21050.delcomtodo.data.remote.response.DataAddLostFoundResponse
...
class LostfoundViewModel(
    ...
    fun putLostfound(
        ...
        // Tentukan status baru berdasarkan isCompleted
        val newStatus = if (isCompleted) "found" else "lost"
